...
describe UsersController do
  ...
  describe "GET 'index' page" do
    ...
    describe "for signed-in users" do
      ...
      it "should nopt have a delete link for non-admins" do
        other_user = User.all.second
        get :index
  ...
  describe "GET 'show'" do
    ...
    it "should have the users's name" do
      get :show, :id => @user.id
    ...
    it "should have a URL" do
      get :show, :id => @user.id
      response.should have_selector("a", :content => user_path(@user),:href => user_path(@user))
    end
  ...
  describe "PUT 'update" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = {:name => "New Name", :email => "user@example.org", :password => "foobar2", :password_confirmation => "foobar2"}
      end
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as a non-admin, signed-in user" do
      ...
      it "should protext the action" do
        test_sign_in(@user)
        delete :destroy, :id => @user
        response.should redirect_to(root_path)
      end
